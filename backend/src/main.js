...
process.on('uncaughtException', function (error) {
    ...
    console.error(error);
    if(isProd) {
        dialog.showErrorBox('An uncaught error has occurred. Please restart the launcher.', error.toString());
    }
});
...
function createLoadingWindow() {
    ...
    loadingWindow.loadFile(path.join(__dirname, 'public', 'index.html'));
    let showing = false;
